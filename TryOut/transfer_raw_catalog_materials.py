...
#     get_sorted_directory_items, get_catalog_id_by_code, delete_catalog_old_period_for_level
# )
#
#
...
#
#
# def _transfer_raw_item_materials_to_catalog(item: DirectoryItem, db_filename: str):
...
#
#
# def transfer_raw_data_to_catalog_materials(operating_db: str):
#     """ Заполняет каталог данными из таблицы с RAW данными для МАТЕРИАЛОВ Глава 1 в таблицу Каталога.
...
#         Удаляет младшие периоды для каталога Материалов
#     """
#     # получить отсортированный справочник 'materials'
#     dir_catalog = get_sorted_directory_items(operating_db, directory_name='materials')
#     ic(dir_catalog)
#     for item in dir_catalog[1:]:
#         _transfer_raw_item_materials_to_catalog(item, operating_db)
#     # удалить из Каталога записи главы 1 период которых
#     # меньше чем текущий (максимальный на данный момент для материалов) период
#     delete_catalog_old_period_for_level(operating_db, parent_code='1')
#
#
#
